...
class AppDynamicsJob(unittest.TestCase):
    ...
    def test_app_dynamics_job(self):
        ...
        driver.find_element_by_id("username").send_keys("170102104")
        driver.find_element_by_id("password").clear()
        driver.find_element_by_id("password").send_keys("cyr981128")
        driver.find_element_by_xpath("/html/body/div/div[2]/div/div/div[2]/div/div/div/div[2]/form[1]/div[5]/input").click()
        print('账号登入')
        ...
        print('输入班级完成')
        '''
        driver.find_element_by_id("fieldSFZX-1").click() # 不在校
        print('不在校选项点击完成')
        ...
        search1.click()
        time.sleep(2)
        search1.send_keys(Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN)
        time.sleep(2)
        search1.click()
        search1.send_keys(Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.ENTER)
        ...
        search2.click()
        search2.send_keys(Keys.DOWN, Keys.DOWN,Keys.DOWN,Keys.DOWN,Keys.DOWN,Keys.DOWN,Keys.DOWN,Keys.DOWN,Keys.DOWN,Keys.DOWN,Keys.DOWN,Keys.ENTER)
        print('城市选择完成')
